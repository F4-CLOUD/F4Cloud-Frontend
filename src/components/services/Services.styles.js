...
export const ServiceTabContainer = styled.div`
  display: flex;
  justify-content: center;
  align-items: center;
  @media only screen and (max-width: 700px) {
...
export const ServiceFeatureContent = styled.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  padding: 2rem;
...
export const ServiceFeatureTitle = styled.h3`
  font-size: 3.6rem;
  font-weight: 400;
  line-height: 1.3;
...
export const ServiceFeatureText = styled.p`
  font-size: 1.6rem;
...
export const ServiceFeatureDetails = styled.div`
  display: flex;
  align-items: center;
`;

export const ServiceFeatureItem = styled.div`
  display: flex;
...
export const ServiceItemIcon = styled(HiUsers)`
  color: #e38b06;
  font-size: 3rem;
  padding-right: 1rem;
`;
...
export const ServiceCardSection = styled.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
...
export const ServiceSmallCards = styled.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
export const ServiceCardHeading = styled.h3`
  font-size: 2.4rem;
  font-weight: 400;
  @media only screen and (max-width: 700px) {
    font-size: 2rem;
...
export const ServiceCardItem = styled.div`
  display: flex;
  justify-content: center;
  align-items: center;
  margin-right: 2.5rem;
...
export const ServiceCardIcon = styled(HiUsers)`
  color: #e38b06;
  font-size: 2rem;
  margin-right: 1.3rem;
  @media only screen and (max-width: 700px) {
...
export const ServiceFeatureImg = styled.div`
  width: 100%;
  display: flex;
  justify-content: center;
  align-items: center;
