...
export const UserFeatureContent = styled.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  padding: 2rem;
...
export const UserFeatureTitle = styled.h3`
  font-size: 3.6rem;
  font-weight: 400;
  line-height: 1.3;
...
export const UserFeatureText = styled.p`
  font-size: 1.6rem;
...
export const UserFeatureDetails = styled.div`
  display: flex;
  align-items: center;
`;

export const UserFeatureItem = styled.div`
  display: flex;
...
export const UserItemTitle = styled.h4`
  font-size: 1.4rem;
  @media only screen and (max-width: 400px) {
    font-size: 1.3rem;
  }
...
export const UserItemIcon = styled(HiUsers)`
  color: #e38b06;
  font-size: 3rem;
  padding-right: 1rem;
`;
...
export const UserSmallCards = styled.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
export const UserCardTitle = styled.h4`
  font-size: 1.4rem;
  @media only screen and (max-width: 700px) {
    font-size: 1.2rem;
  }
...
export const UserCardIcon = styled(HiUsers)`
  color: #e38b06;
  font-size: 2rem;
  margin-right: 1.3rem;
  @media only screen and (max-width: 700px) {
...
export const UserFeatureImg = styled.div`
  width: 100%;
  display: flex;
  justify-content: center;
  align-items: center;
