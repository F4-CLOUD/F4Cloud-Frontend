...
export const WorksIconContainer = styled.div`
  ...
  align-items: center;
`;
export const WorksIcon1 = styled(BiFile)`
  color: #333;
  font-size: 8rem;
`;

export const WorksIcon2 = styled(BiHash)`
  color: #333;
  font-size: 6rem;
`;
export const WorksIcon3 = styled(GiHumanTarget)`
  color: #333;
  font-size: 6rem;
`;

export const WorksIcon4 = styled(BsCloud)`
  color: #333;
  font-size: 6rem;
`;
